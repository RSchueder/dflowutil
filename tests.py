...
# plot map
#################################################################################
mapdir = 'p:\\11200975-hongkongwaq\\WAQ\\03_baseCase\\A07\\wrong_ref_date_DFM_OUTPUT_HK-FMWAQ\\'
...
with open('prn_areas.pkl', 'wb') as f:
...
dflowutil.show_waq_segment(grd, 8, segs)
...
dflowutil.show_waq_segment(grd, 20, segs)
'''
...
model.build()
'''
dflowutil.plot_net(r'p:\1221207-kuweit-iczm-marshlands\02_Marshlands\task_5D_-_Water_Quality\02_modelSetup\T04\7_zones_4x4_waqgeom.nc')
